...
|--------|-------------------------------------------|----------|-----------|-------|
| ✅     | titpetric/vuego                           | 84.88%   | 1109      | 3632  |
...
| ❌     | titpetric/vuego/cmd/vuego/commands/tour   | 48.13%   | 7         | 59    |
...
| ❌     | titpetric/vuego/server                    | 72.74%   | 25        | 178   |
| ✅     | titpetric/vuego/server/tour               | 91.75%   | 89        | 368   |
...
| ✅     | titpetric/vuego                           | WithComponents                    | 94.10%   | 12        |
...
| ✅     | titpetric/vuego/cmd/vuego/commands/tour   | Run                               | 44.40%   | 2         |
| ❌     | titpetric/vuego/cmd/vuego/commands/tour   | Serve                             | 0.00%    | 5         |
...
| ✅     | titpetric/vuego/server                    | LoadDataFile                      | 90.90%   | 5         |
| ✅     | titpetric/vuego/server                    | Middleware                        | 75.00%   | 1         |
| ✅     | titpetric/vuego/server                    | MiddlewareDir                     | 75.00%   | 1         |
| ✅     | titpetric/vuego/server                    | Render                            | 91.70%   | 5         |
| ✅     | titpetric/vuego/server                    | RenderHandler                     | 85.70%   | 6         |
| ✅     | titpetric/vuego/server                    | WithLoadOption                    | 0.00%    | 0         |
| ✅     | titpetric/vuego/server                    | buildTemplateFS                   | 100.00%  | 2         |
| ✅     | titpetric/vuego/server                    | combinedFS.Open                   | 100.00%  | 1         |
| ✅     | titpetric/vuego/server                    | combinedFS.ReadDir                | 0.00%    | 0         |
| ✅     | titpetric/vuego/server                    | middlewareHandler.ServeHTTP       | 100.00%  | 2         |
| ✅     | titpetric/vuego/server                    | middlewareHandler.serveVuego      | 81.80%   | 2         |
| ✅     | titpetric/vuego/server/tour               | EmbeddedContentFS                 | 100.00%  | 0         |
| ✅     | titpetric/vuego/server/tour               | Handler                           | 80.00%   | 4         |
| ✅     | titpetric/vuego/server/tour               | Lesson.DataFile                   | 100.00%  | 4         |
| ✅     | titpetric/vuego/server/tour               | Lesson.PrimaryTemplate            | 100.00%  | 4         |
| ✅     | titpetric/vuego/server/tour               | ParseTour                         | 91.30%   | 13        |
| ✅     | titpetric/vuego/server/tour               | Tour.FirstLesson                  | 100.00%  | 1         |
| ✅     | titpetric/vuego/server/tour               | Tour.GetLesson                    | 100.00%  | 3         |
| ✅     | titpetric/vuego/server/tour               | Tour.LessonCount                  | 100.00%  | 0         |
| ✅     | titpetric/vuego/server/tour               | ValidateLesson                    | 75.00%   | 3         |
| ✅     | titpetric/vuego/server/tour               | ValidateTour                      | 75.00%   | 3         |
| ✅     | titpetric/vuego/server/tour               | chapterDir                        | 75.00%   | 1         |
| ✅     | titpetric/vuego/server/tour               | extractFileRefs                   | 100.00%  | 7         |
| ✅     | titpetric/vuego/server/tour               | loadLessonFilesFromRefs           | 94.70%   | 12        |
| ✅     | titpetric/vuego/server/tour               | parseChapter                      | 92.30%   | 3         |
| ✅     | titpetric/vuego/server/tour               | parseMarkdownLessons              | 89.30%   | 22        |
| ✅     | titpetric/vuego/server/tour               | tourHandler.ServeHTTP             | 100.00%  | 1         |
| ✅     | titpetric/vuego/server/tour               | tourHandler.handleLesson          | 77.80%   | 2         |
| ✅     | titpetric/vuego/server/tour               | tourHandler.handleRender          | 84.60%   | 3         |
| ✅     | titpetric/vuego/server/tour               | tourHandler.renderTourPage        | 100.00%  | 0         |
| ✅     | titpetric/vuego/server/tour               | tourHandler.serveIndex            | 100.00%  | 3         |
