...
|--------|----------------------------------|----------|-----------|-------|
| ❌     | titpetric/vuego                  | 73.79%   | 1172      | 3866  |
| ❌     | titpetric/vuego/diff             | 58.69%   | 155       | 464   |
| ❌     | titpetric/vuego/formatter        | 60.04%   | 113       | 374   |
...
| ✅     | titpetric/vuego                  | OverlayFS.Glob                    | 100.00%  | 5         |
| ✅     | titpetric/vuego                  | OverlayFS.Open                    | 85.70%   | 4         |
| ✅     | titpetric/vuego                  | OverlayFS.ReadDir                 | 91.30%   | 9         |
...
| ✅     | titpetric/vuego                  | View                              | 25.00%   | 0         |
| ✅     | titpetric/vuego                  | Vue.DefaultFuncMap                | 50.00%   | 0         |
...
| ❌     | titpetric/vuego                  | Vue.buildClassString              | 46.40%   | 7         |
| ❌     | titpetric/vuego                  | Vue.buildStyleString              | 43.80%   | 10        |
| ❌     | titpetric/vuego                  | Vue.callFunc                      | 45.20%   | 31        |
...
| ❌     | titpetric/vuego                  | Vue.evalFilter                    | 50.00%   | 6         |
| ❌     | titpetric/vuego                  | Vue.evalFor                       | 76.00%   | 6         |
| ✅     | titpetric/vuego                  | Vue.evalInclude                   | 88.90%   | 5         |
| ❌     | titpetric/vuego                  | Vue.evalObjectBinding             | 53.80%   | 6         |
| ❌     | titpetric/vuego                  | Vue.evalPipe                      | 43.20%   | 16        |
| ✅     | titpetric/vuego                  | Vue.evalSegment                   | 36.80%   | 5         |
| ✅     | titpetric/vuego                  | Vue.evalSlot                      | 91.70%   | 41        |
| ❌     | titpetric/vuego                  | Vue.evalTemplate                  | 37.10%   | 111       |
...
| ❌     | titpetric/vuego                  | Vue.evaluate                      | 44.80%   | 109       |
| ✅     | titpetric/vuego                  | Vue.evaluateChildren              | 57.10%   | 1         |
...
| ✅     | titpetric/vuego                  | Vue.mergeStyles                   | 50.00%   | 2         |
| ❌     | titpetric/vuego                  | Vue.parseObjectPairs              | 35.20%   | 10        |
...
| ✅     | titpetric/vuego                  | WithFS                            | 60.00%   | 0         |
| ✅     | titpetric/vuego                  | WithFuncs                         | 100.00%  | 0         |
| ✅     | titpetric/vuego                  | WithLessProcessor                 | 50.00%   | 0         |
| ✅     | titpetric/vuego                  | WithProcessor                     | 0.00%    | 0         |
| ✅     | titpetric/vuego                  | assignSeenAttrs                   | 100.00%  | 5         |
| ✅     | titpetric/vuego                  | camelToKebab                      | 50.00%   | 5         |
| ❌     | titpetric/vuego                  | classifySegment                   | 40.00%   | 7         |
| ✅     | titpetric/vuego                  | containsInterpolation             | 100.00%  | 1         |
| ❌     | titpetric/vuego                  | convertValue                      | 32.50%   | 24        |
| ✅     | titpetric/vuego                  | defaultFunc                       | 42.90%   | 2         |
...
| ❌     | titpetric/vuego                  | fileFunc                          | 32.00%   | 9         |
| ❌     | titpetric/vuego                  | formatDateFunc                    | 0.00%    | 1         |
| ✅     | titpetric/vuego                  | formatTimeFunc                    | 31.20%   | 4         |
...
| ❌     | titpetric/vuego                  | jsonFileFunc                      | 36.00%   | 11        |
| ✅     | titpetric/vuego                  | jsonFunc                          | 75.00%   | 1         |
| ✅     | titpetric/vuego                  | jsonPrettyFunc                    | 75.00%   | 1         |
| ✅     | titpetric/vuego                  | lenFunc                           | 37.50%   | 1         |
| ✅     | titpetric/vuego                  | lowerFunc                         | 33.30%   | 1         |
| ❌     | titpetric/vuego                  | parseArgs                         | 50.00%   | 11        |
| ✅     | titpetric/vuego                  | parseFor                          | 86.70%   | 8         |
| ❌     | titpetric/vuego                  | parsePipeExpr                     | 50.00%   | 6         |
| ❌     | titpetric/vuego                  | parseStyleMap                     | 46.40%   | 6         |
| ✅     | titpetric/vuego                  | parseStyleString                  | 100.00%  | 6         |
| ✅     | titpetric/vuego                  | parseVSlotDirective               | 50.00%   | 4         |
| ❌     | titpetric/vuego                  | parseValue                        | 31.80%   | 7         |
...
| ✅     | titpetric/vuego                  | template.Err                      | 50.00%   | 0         |
| ✅     | titpetric/vuego                  | template.Fill                     | 55.60%   | 1         |
| ✅     | titpetric/vuego                  | template.Get                      | 52.90%   | 4         |
...
| ❌     | titpetric/vuego                  | template.layout                   | 79.30%   | 11        |
| ✅     | titpetric/vuego                  | template.new                      | 33.30%   | 0         |
| ✅     | titpetric/vuego                  | template.renderWithoutLayout      | 66.70%   | 1         |
| ✅     | titpetric/vuego                  | template.resolveLayoutPath        | 100.00%  | 4         |
| ❌     | titpetric/vuego                  | titleFunc                         | 54.50%   | 6         |
| ✅     | titpetric/vuego                  | toMapData                         | 85.70%   | 3         |
| ✅     | titpetric/vuego                  | trimFunc                          | 66.70%   | 1         |
| ✅     | titpetric/vuego                  | typeFunc                          | 50.00%   | 0         |
| ✅     | titpetric/vuego                  | upperFunc                         | 40.00%   | 1         |
| ❌     | titpetric/vuego                  | yamlFileFunc                      | 37.50%   | 11        |
...
| ✅     | titpetric/vuego/formatter        | FormatString                      | 50.00%   | 0         |
| ✅     | titpetric/vuego/formatter        | Formatter.Format                  | 100.00%  | 2         |
| ✅     | titpetric/vuego/formatter        | Formatter.formatFragment          | 93.30%   | 2         |
| ✅     | titpetric/vuego/formatter        | Formatter.formatFragmentChildren  | 25.00%   | 1         |
| ✅     | titpetric/vuego/formatter        | Formatter.formatFullDocument      | 92.30%   | 7         |
| ❌     | titpetric/vuego/formatter        | Formatter.formatNode              | 39.40%   | 71        |
| ✅     | titpetric/vuego/formatter        | Formatter.formatNodeChildren      | 40.00%   | 1         |
| ✅     | titpetric/vuego/formatter        | Formatter.isIgnorableWhitespace   | 40.00%   | 1         |
| ✅     | titpetric/vuego/formatter        | Formatter.renderCloseTag          | 33.30%   | 0         |
| ✅     | titpetric/vuego/formatter        | Formatter.renderOpenTag           | 57.10%   | 3         |
| ❌     | titpetric/vuego/formatter        | Formatter.shouldKeepInline        | 31.40%   | 14        |
| ✅     | titpetric/vuego/formatter        | Formatter.splitFrontmatter        | 18.80%   | 5         |
| ✅     | titpetric/vuego/formatter        | IndentString                      | 66.70%   | 3         |
| ✅     | titpetric/vuego/formatter        | NewFormatter                      | 100.00%  | 0         |
| ✅     | titpetric/vuego/formatter        | NewFormatterWithOptions           | 100.00%  | 0         |
| ✅     | titpetric/vuego/formatter        | isVoidElement                     | 33.30%   | 3         |
